...
CGUIMessage::CGUIMessage(int msg, int senderID, int controlID, int64_t param1, int64_t param2, CFileItemList *item)
{
  m_message = msg;
  m_senderID = senderID;
  m_controlID = controlID;
...
CGUIMessage::CGUIMessage(
    int msg, int senderID, int controlID, int64_t param1, int64_t param2, const CGUIListItemPtr& item)
  : m_item(item)
{
  m_message = msg;
  m_senderID = senderID;
...
int64_t CGUIMessage::GetParam1() const
{
  return m_param1;
}

int64_t CGUIMessage::GetParam2() const
{
  return m_param2;
}
